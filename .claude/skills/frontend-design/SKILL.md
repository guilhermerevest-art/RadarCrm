...
Typography carries the personality of the page. You don't need a different typeface for display or headline text and body contents: use one family or two, and if two, make them clearly distinct.
