      ...
      <CardContent className="pt-4">
        {magicLinkSent ? (
          <div className="text-center py-6 animate-fade-in">
            <div className="mx-auto mb-4 flex h-16 w-16 items-center justify-center rounded-2xl bg-gradient-to-br from-emerald-500/20 to-emerald-500/10 border border-emerald-500/20">
              <Mail className="h-8 w-8 text-emerald-600" />
            </div>
            <h3 className="text-xl font-bold text-foreground">E-mail enviado!</h3>
    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-background via-background to-muted/30 px-4">
      ...
      <div className="absolute inset-0 -z-10 overflow-hidden">
        ...
        <div className="absolute -bottom-1/2 -right-1/2 w-full h-full">
          <div className="absolute bottom-1/4 right-1/4 h-96 w-96 rounded-full bg-secondary/5 blur-3xl animate-float" style={{ animationDelay: '1.5s' }} />
        </div>
        {/* Grid pattern */}
        ...
        <div className="mb-8">
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="flex flex-col">
              ...
              <span className="text-xs text-muted-foreground font-medium">CRM para construção civil</span>
            </div>
          </div>
        </div>
